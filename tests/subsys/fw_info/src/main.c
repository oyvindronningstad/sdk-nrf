...
u8_t fw_info_find_buf[0x1000 + sizeof(dummy_s1)];

u32_t dummy_align;
u8_t memeq_buf1[] = {1, 2, 3, 4, 5, 6, 7, 8}; /* Aligned */
u8_t memeq_buf2[] = {1, 2, 3, 4, 5, 6, 7, 8}; /* Aligned */
u8_t dummy_misalign;
u8_t memeq_buf3[] = {1, 2, 3, 4, 5, 6, 7, 8}; /* Not aligned */
...
{
	zassert_true(memeq(memeq_buf1, memeq_buf2, sizeof(memeq_buf1)),
		"memeq failed");
	zassert_true(memeq(memeq_buf1, memeq_buf3, sizeof(memeq_buf3)),
		"memeq failed");
	zassert_true(memeq(memeq_buf3, memeq_buf2, sizeof(memeq_buf2)),
		"memeq failed");

	memeq_buf2[5]++;
	zassert_false(memeq(memeq_buf1, memeq_buf2, sizeof(memeq_buf1)),
		"memeq failed");
	zassert_true(memeq(memeq_buf1, memeq_buf3, sizeof(memeq_buf3)),
		"memeq failed");
	zassert_false(memeq(memeq_buf3, memeq_buf2, sizeof(memeq_buf2)),
		"memeq failed");
